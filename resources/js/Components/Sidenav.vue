<template>
    <div class="col-lg-1 col-md-1 pt-5 pt-lg-0 ms-lg-5 text-center">
        <Link
            href="/profile"
            class="avatar avatar-md border-0 mb-3"
            v-tooltip="'Profile'"
        >
            <img
        ...
        <Link
            ...
            :class="
                $page.component === 'Attendance/Index'
                    ...
                    : 'btn-white'
            "
            class="btn border-radius-lg p-2 mt-0 mt-md-2 mx-2 mx-md-0"
            v-tooltip="'Home'"
        >
        ...
        <Link
            ...
            :class="
                $page.component === 'Attendance/History'
                    ...
                    : 'btn-white'
            "
            class="btn border-radius-lg p-2"
            v-tooltip="'History'"
        >
            <i class="fas fa-history p-2"></i>
        </Link>
        <Link
            href="/attendance/performance"
            :class="
                $page.component === 'Attendance/Performance'
                    ? 'btn-primary'
                    : 'btn-white'
            "
            class="btn border-radius-lg p-2 mx-2"
