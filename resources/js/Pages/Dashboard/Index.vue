                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <a
                                        v-if="workingOnsiteData.length > 0"
                                        href="javascript:;"
                                        data-bs-toggle="modal"
                                        data-bs-target="#userModal"
                                        @click="showUser('workingOnsite')"
                                        ><h5
                                            class="font-weight-bolder text-success"
                                        >
                                            {{ workingOnsiteData.length }}
                                        </h5></a
                                    >
                                    <h5
                                        v-else
                            ...
                            <div class="col-4 text-end">
                                <a
                                    ...
                                    data-bs-toggle="modal"
                                    data-bs-target="#userModal"
                                    class="icon icon-shape bg-gradient-primary text-center rounded-circle"
                                    @click="showUser('workingOnsite')"
                                >
                                    <h3>
                                        <i
                                            class="fa-solid fa-person-shelter mt-2 text-white"
                                        ></i>
                                    </h3>
                                </a>
                                <span
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <a
                                        v-if="workingRemoteData.length > 0"
                                        href="javascript:;"
                                        data-bs-toggle="modal"
                                        data-bs-target="#userModal"
                                        @click="showUser('workingRemote')"
                                        ><h5
                                            class="font-weight-bolder text-success"
                                        >
                                            {{ workingRemoteData.length }}
                                        </h5></a
                                    >
                                    <h5
                                        v-else
                            ...
                            <div class="col-4 text-end">
                                ...
                                >
                                    <h3>
                                        <i
                                            class="fa-solid fa-person-snowboarding mt-2 text-white"
                                        ></i>
                                    </h3>
                                </a>
                                <span
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <a
                                        v-if="outOfficeData.length > 0"
                                        href="javascript:;"
                                        data-bs-toggle="modal"
                                        data-bs-target="#userModal"
                                        @click="showUser('outOffice')"
                                    >
                                        <h5
                                            class="font-weight-bolder text-warning"
                                        >
                                            {{ outOfficeData.length }}
                                        </h5></a
                                    >
                                    <h5
                                        v-else
                            ...
                            <div class="col-4 text-end">
                                ...
                                >
                                    <h3>
                                        <i
                                            class="fa-solid fa-person-walking-luggage mt-2 text-white"
                                        ></i>
                                    </h3>
                                </a>
                                <span
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <a
                                        v-if="outSickData.length > 0"
                                        href="javascript:;"
                                        data-bs-toggle="modal"
                                        data-bs-target="#userModal"
                                        @click="showUser('outSick')"
                                    >
                                        <h5
                            ...
                            <div class="col-4 text-end">
                                ...
                                >
                                    <h3>
                                        <i
                                            class="fa-solid fa-bed mt-2 text-white"
                                        ></i>
                                    </h3>
                                </a>
                                <span
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    ...
                                    <a
                                        v-if="notAvailableData.length > 0"
                                        href="javascript:;"
                                        data-bs-toggle="modal"
                                        data-bs-target="#userModal"
                                        @click="showUser('notAvailable')"
                                    >
                                        <h5
                                            class="font-weight-bolder text-secondary"
                                        >
                                            {{ notAvailableData.length }}
                                        </h5></a
                                    >
                                    <h5
                                        v-else
                            ...
                            <div class="col-4 text-end">
                                ...
                                >
                                    <h3>
                                        <i
                                            class="fa-solid fa-person-through-window mt-2 text-white"
                                        ></i>
                                    </h3>
                                </a>
                                <span
                            ...
                            <div class="col">
                                ...
                                >
                                    <input
                                        ...
                                        type="checkbox"
                                        id="strugglingCheckbox"
                                        v-model="struggling"
                                        @change="getData"
                                    />
                                    <label
                                        class="form-check-label"
                                        for="strugglingCheckbox"
                                        >Struggling</label
                                    >
                                </div>
                            </div>
                        ...
                        <ul v-if="activitiesData.length > 0" class="list-group">
                            ...
                            >
                                <div class="d-flex align-items-center">
                                    <span
                                        v-if="activity.end"
                                        class="btn btn-icon-only btn-rounded btn-outline-success mb-0 me-3 d-flex align-items-center justify-content-center"
                                        ><i class="fa-solid fa-check"></i
                                    ></span>
                                    <span
                                        v-else
                                        class="btn btn-icon-only btn-rounded btn-outline-warning mb-0 me-3 d-flex align-items-center justify-content-center"
                                        ><i class="fa-solid fa-spinner"></i
                                    ></span>

                                    <span
                                        class="avatar avatar-md border-0 me-3"
                                        :title="activity.attendance.user.name"
                                    >
                                        <img
                                            :src="
                                                activity.attendance.user.avatar
                                                    ? '/storage/' +
                                                      activity.attendance.user
                                                          .avatar
                                    ...
                                    <div class="d-flex flex-column">
                                        <div>
                                            <span
                                                class="text-sm font-weight-bold opacity-8"
                                                >{{
                                                    activity.attendance.user
                                                        .name
                                                }}</span
                                            ...
                                            <span
                                                ...
                                                class="badge bg-gradient-primary ms-2"
                                        ...
                                        <p class="mb-1 mt-2 text-dark text-sm">
                        ...
                        <ul class="list-group">
                            ...
                            >
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <p
                                            class="mt-3 text-sm font-weight-bold opacity-5"
                                            style="color: black !important"
                                        >
                                            {{ user.name }}
                                        </p>
                                        <span
                                            v-if="user.struggle_text == 'Yes'"
...
const showUser = (status) => {
    if (status == "workingRemote") {
        users.value = workingRemoteData.value;
        userListTitle.value = "Working Remote";
    }

    if (status == "workingOnsite") {
        users.value = workingOnsiteData.value;
