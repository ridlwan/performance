                        ...
                        <ul v-if="activities.length > 0" class="list-group">
                            ...
                            >
                                ...
                                >
                                    <div class="d-flex flex-column">
                                        <p
                                            class="mb-1 text-dark opacity-8"
                                            style="color: black !important"
                                        >
                                            {{
                                                $filters.formatTime(
...
let startDate = ref(
    moment(String(props.filters.startDate)).format("YYYY-MM-DD")
);
...
const showDetail = (event, chartContext, config) => {
    ...
    axios
        ...
        .then((response) => {
            if (
                response.data == "Out Office" ||
                response.data == "Out Sick" ||
